...
3.  **Aim:** Hold your hand **open (🖐️)** to move the crosshair over a hamster hole.
4.  **Ready:** Make a **fist (✊)** to summon your hammer.
...
3.  **瞄准：** 将手掌 **张开 (🖐️)**，屏幕上会出现准星。
4.  **蓄力：** 将手 **握紧成拳 (✊)**，召唤出惩罚之槌。
